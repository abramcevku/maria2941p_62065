...
-- Distract opponents by moving strategically if surrounded
function distract()
    local surroundingOpponents = 0
    for target, state in pairs(CurrentGameState.Players) do
    ...
    if surroundingOpponents > 3 then
        print(colors.purple .. "Surrounded by opponents, distracting..." .. colors.reset)
        moveToStrategicPosition()
    end
end
